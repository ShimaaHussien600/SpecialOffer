...
export class AdvertiserContactUs extends Component {
  constructor(props) {
    super(props);
    this.state = {
    };
    ...
    return (
      <View
        ...
        <View
          ...
          <RegularButton
            onClick={() => { }}
            buttonStyle={{ marginTop: hp('14%'), width: wp('80%'), height: hp('8%'), borderRadius: 3, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.darkRed }}
            buttonText={'ارسال'}
